...
public class DeleteSprintPopup extends Window implements Handler, Constants {
    private static final long serialVersionUID = -4646935037822605073L;
    ...
    public DeleteSprintPopup(RefreshableComponent parentLayout, Sprint sprint) {
        super("Delete Sprint");
        setDebugId(DELETE_SPRINT_POPUP);
    ...
    private void addText() {
        String text = "Are you sure you want to delete the sprint?";
        text += "<br><br><table>";
        text += "<tr><td>Sprint Name:&nbsp;&nbsp;</td><td><b>" + sprint.getName() + "</b></td></tr>";
        text += "<tr><td>Created By:&nbsp;&nbsp;</td><td><b>" + (sprint.getCreatedBy() != null ? sprint.getCreatedBy().getFullName() : "") + "</b></td></tr>";
        String creationDate = dateFormatter.formatToMediumDateAndTime(sprint.getCreationDate());
        text += "<tr><td>Creation Date:&nbsp;&nbsp;</td><td><b>" + creationDate + "</b></td></tr>";
        text += "</table>";
        text += "<br>Please note, deleting will also delete child components like tasks.";
    ...
    private void addDeleteButton(HorizontalLayout layout) {
        ...
        deleteButton.setDebugId(DELETE_SPRINT_POPUP_DELETE);
    ...
    private void addCancelButton(HorizontalLayout layout) {
        ...
        cancelButton.setDebugId(DELETE_SPRINT_POPUP_CANCEL);
