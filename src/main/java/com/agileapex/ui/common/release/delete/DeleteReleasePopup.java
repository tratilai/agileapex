...
public class DeleteReleasePopup extends Window implements Handler, Constants {
    private static final long serialVersionUID = 4525824850536420195L;
    ...
    public DeleteReleasePopup(RefreshableComponent parentLayout, Release release) {
        super("Delete Release");
        setDebugId(DELETE_RELEASE_POPUP);
    ...
    private void addText() {
        String text = "Are you sure you want to delete the release?";
        text += "<br><br><table>";
        text += "<tr><td>Release Name:&nbsp;&nbsp;</td><td><b>" + release.getName() + "</b></td></tr>";
        text += "<tr><td>Created By:&nbsp;&nbsp;</td><td><b>" + (release.getCreatedBy() != null ? release.getCreatedBy().getFullName() : "") + "</b></td></tr>";
        String creationDate = dateFormatter.formatToMediumDateAndTime(release.getCreationDate());
        text += "<tr><td>Creation Date:&nbsp;&nbsp;</td><td><b>" + creationDate + "</b></td></tr>";
        text += "</table>";
        text += "<br>Please note, deleting will also delete child components like sprints and tasks.";
    ...
    private void addDeleteButton(HorizontalLayout layout) {
        ...
        deleteButton.setDebugId(DELETE_RELEASE_POPUP_DELETE);
    ...
    private void addCancelButton(HorizontalLayout layout) {
        ...
        cancelButton.setDebugId(DELETE_RELEASE_POPUP_CANCEL);
